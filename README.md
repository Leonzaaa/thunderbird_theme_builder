# MTS 2026 для Thunderbird

Тёмная тема для Mozilla Thunderbird в фирменном стиле [МТС](https://mts.ru/) 2026.

Основана на дизайн-системе GRANAT: глубокий тёмный фон, фирменный красный `#ED1C24` как основной акцент, современные нейтральные тона.
